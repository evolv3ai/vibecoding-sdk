...
import { ClientOptions } from 'vibecoding';
...
export { ClientOptions } from 'vibecoding';
...
export function initMcpServer(params: {
  ...
  const client = new Vibecoding(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client ||
    new Vibecoding({
      environment: (readEnv('VIBECODING_ENVIRONMENT') || undefined) as any,
